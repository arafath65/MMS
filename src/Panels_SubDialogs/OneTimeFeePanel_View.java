...
public class OneTimeFeePanel_View extends javax.swing.JPanel {
    ...
    public OneTimeFeePanel_View(String username, String role) {
    ...
    private void buttonGradient3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonGradient3ActionPerformed
        ...
        try {
            ...
            // VALIDATION
            // ==============================
            if (fm_fees_cheq_full_fees_Textfield.getText().trim().isEmpty() || fm_fees_cheq_cheque_number.getText().trim().isEmpty()
                    || fm_fees_cheq_cheque_bank.getEditor().getItem().toString().trim().isEmpty() || fm_fees_cheq_cheque_amount.getText().trim().isEmpty()
                    || fm_fees_cheq_cheque_amount.getText().equals("0")) {

                JOptionPane.showMessageDialog(null,
                        "Fields cannot be empty or 0",
                        "Invalid Input",
            ...
            double pendingCheque = dao.getStudentPendingChequeTotal(st_id);
            double totalBalance = getTotalBalanceFromTable();

            double actualBalance = totalBalance - pendingCheque;
            double cheq_final_bal = GeneralMethods.parseCommaNumber(
                    fm_fees_cheq_cheque_sum_bal_Textfield.getText()
            );
            ...
            // ==============================
            // 🚫 STRICT VALIDATION (NO ROUND)
            // ==============================
            if (amount_paid > cheq_final_bal) {
                ...
                JOptionPane.showMessageDialog(null,
                        ...
                        + "\nAllowed Amount : " + GeneralMethods.formatWithComma(cheq_final_bal),
                        "Invalid Payment",
                        JOptionPane.WARNING_MESSAGE);

                fm_fees_cheq_cheque_amount.requestFocus();
                fm_fees_cheq_cheque_amount.selectAll();
                return;
            }
            ...
            // ==============================
            String logDetail = String.format(
                    "Cheque Payment | Enrollment: %d | Cheque No: %s | Bank: %s | Branch: %s | Amount: %s",
                    en_id,
                    chq_no,
                    bank_name,
                    bank_branch,
            ...
            for (Object[] row : list) {
                ...
                model2.addRow(new Object[]{
                    ...
                    GeneralMethods.parseCommaNumber(row[2].toString())
                    ),
                    paymentMethod,
                    chequeStatus
                });
...
//        }
    ...
    private void buttonGradient4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonGradient4ActionPerformed
        ...
        try {
            ...
            // ==============================
            // VALIDATION - EMPTY / ZERO
            // ==============================
            if (fm_fees_oneTime_total_paid_Textfield.getText().trim().isEmpty()
                    || fm_fees_oneTime_total_paid_Textfield.getText().equals("0")) {

                JOptionPane.showMessageDialog(null,
                        "Paying amount cannot be empty or 0",
                        "Invalid Input",
                        JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            double actualBalance = totalBalance - pendingCheque;
            double cheq_final_bal = GeneralMethods.parseCommaNumber(
                    fm_fees_oneTime_chq_sum_bal_Textfield.getText()
            );
            ...
            double amount_paid = GeneralMethods.parseCommaNumber(
                    fm_fees_oneTime_total_paid_Textfield.getText()
            );
            ...
            if (amount_paid > cheq_final_bal) {
                ...
                JOptionPane.showMessageDialog(null,
                        "Payment amount does not match.\n\n"
                        + "Total Balance : " + GeneralMethods.formatWithComma(GeneralMethods.parseCommaNumber(fm_fees_oneTime_total_balance_Textfield.getText()))
                        + "\nPending Cheques : " + GeneralMethods.formatWithComma(GeneralMethods.parseCommaNumber(fm_fees_oneTime_chq_sum_Textfield.getText()))
                        + "\nAllowed Amount : " + GeneralMethods.formatWithComma(cheq_final_bal),
                        "Invalid Payment",
                        JOptionPane.WARNING_MESSAGE);
                fm_fees_oneTime_total_paid_Textfield.requestFocus();
                fm_fees_oneTime_total_paid_Textfield.selectAll();
            ...
            // ==============================
            String logDetail = String.format(
                    "One-time fee payment for Enrollment: %d via %s",
                    en_id, pay_method
            );
            ...
            fm_fees_oneTime_total_paid_Textfield.setText("");
            fm_fees_oneTime_total_balance_Textfield.setText("");
            fm_fees_oneTime_chq_sum_Textfield.setText("");
            fm_fees_oneTime_chq_sum_bal_Textfield.setText("");
            fm_fees_oneTime_total_paid_Textfield.requestFocus();
            JOptionPane.showMessageDialog(null, "Payment saved successfully.", "Payment Processed", JOptionPane.INFORMATION_MESSAGE);
